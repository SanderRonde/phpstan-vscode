...
// source: /home/sanderronde/git/phpstan-vscode/test/multi-config-demo/src/phpstan.neon
// source: array
...
class Container_9e7071f660 extends _PHPStan_4f7beffdf\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService056(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_9e7071f660 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					[],
					['/home/sanderronde/git/phpstan-vscode/test/multi-config-demo/src/php'],
					false
				);
			}
		};
	...
	public function createService063(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/sanderronde/git/phpstan-vscode/test/multi-config-demo/src/phpstan.neon',
			],
			null,
			[
				'phar:///home/sanderronde/git/phpstan-vscode/test/multi-config-demo/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createServiceContainer(): Container_9e7071f660
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => null,
			'level' => 9,
			'paths' => ['/home/sanderronde/git/phpstan-vscode/test/multi-config-demo/src/php'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => [],
			'scanDirectories' => ['/home/sanderronde/git/phpstan-vscode/test/multi-config-demo/src/php'],
			'parallel' => [
				'jobSize' => 20,
